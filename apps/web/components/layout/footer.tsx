      ...
      <div className="mx-auto grid w-full max-w-6xl gap-8 px-4 py-10 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="space-y-3">
          ...
          <p className="text-sm leading-relaxed text-foreground-muted">
            A dark, modern starter crafted for fast product launches without
            rewriting auth and platform foundations.
          </p>
        </div>
        ...
        <div className="space-y-2 text-sm">
          ...
          <Link
            className="block text-foreground-muted hover:text-primary"
            href="/home"
          >
            Home
          </Link>
